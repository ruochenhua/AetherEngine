//! Terrain splatting shader — matches the runtime TerrainPass implementation.
//!
//! Samples a splat map and blends up to four material layer albedo textures,
//! then writes the deferred GBuffer outputs. Kept in the shader library for
//! compile validation and as a reference for the embedded terrain shader.
