...
pub(super) fn create_device_objects(device: &wgpu::Device) -> DeviceObjects {
    ...
    let upsample_source = SSR_UPSAMPLE_SHADER;
...
/// WGSL source for the SSR trace pass (screen-space reflections).
pub(crate) const SSR_SHADER: &str = r#"
struct VertexOutput {
...
/// WGSL source for the SSR upsample pass.
pub(crate) const SSR_UPSAMPLE_SHADER: &str = r#"
struct SSRSettings {
    camera_pos: vec3<f32>,
    _pad0: f32,
    view_proj: mat4x4<f32>,
